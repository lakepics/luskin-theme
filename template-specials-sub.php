<?php
/*
 * Template Name: Specials - Subpage
 */
?>
<?php get_header(); ?>
...
$parkings = get_field( 'parking_button');
if ( $parkings) 
    foreach ( $parkings as $parking)
    echo '<div class="section-description container clearfix parking">';
    echo '<div class="res-content bottom-30 parking__content">'. $parking['content'] .'</div>';
    echo '</div>';
?>
        <?php endwhile; ?>
