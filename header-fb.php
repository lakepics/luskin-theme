...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" <?php language_attributes() ?>>
	<head>
		...
		-->
		<!-- Flipbook Styles -->
		<link rel="stylesheet" type="text/css" href="/wp-content/themes/luskin/styles/fb/style.css">
		<link rel="stylesheet" type="text/css" href="/wp-content/themes/luskin/styles/fb/page-styles.css">
		<!-- Flipbook Scripts -->
		<script type="text/javascript" src="/wp-content/themes/luskin/scripts/fb/swfobject2.js"></script>
        <script type="text/javascript" src="http://code.jquery.com/jquery-1.7.1.min.js"></script>
        <script type="text/javascript" src="/wp-content/themes/luskin/scripts/fb/jquery.easing.1.3.js"></script>
        <script type="text/javascript" src="/wp-content/themes/luskin/scripts/fb/turn.js"></script>
        <script type="text/javascript" src="/wp-content/themes/luskin/scripts/fb/flipbook.js"></script>
        <script type="text/javascript" src="/wp-content/themes/luskin/scripts/fb/jquery.doubletap.js"></script>
        <script type="text/javascript" src="/wp-content/themes/luskin/scripts/fb/jquery.color.js"></script>
		...
		<script>(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','//www.google-analytics.com/analytics.js','ga');ga('create', 'UA-60141822-1', 'auto');ga('send', 'pageview');</script>
        <!-- Google Tag Manager added to head element per ScreenPilot -->
        <noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-PM45X6" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
        <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start': new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-PM45X6');</script>
